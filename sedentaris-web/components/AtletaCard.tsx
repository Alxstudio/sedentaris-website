...
const disciplineStyle: Record<string, string> = {
  ...
  'Atletisme':       'bg-emerald-50 text-emerald-700 border border-emerald-200',
  'Paraatletisme':   'bg-blue-50 text-[#29ABE2] border border-blue-200',
}
  ...
  return (
    <div ref={ref}>
      <div className="group bg-white rounded-lg overflow-hidden border border-gray-100 hover:border-[#29ABE2]/30 hover:shadow-lg transition-all duration-300">
        ...
        {/* Photo — aspect ratio fijo, misma altura para todas */}
        <div className="relative aspect-3/4 overflow-hidden bg-gray-100">
          ...
          {/* Discipline tags — siempre visibles en móvil, hover en desktop */}
          ...
          <div className="w-8 h-8 shrink-0">
            {atlete.instagram && (
              <a
                ...
                className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-200 text-gray-400 hover:text-[#29ABE2] hover:border-[#29ABE2] transition-all duration-150"
              >
